"""With this script we convert voc labels to yolo labels
and aggregate them into single files for the train and test sets."""
...
# Inputs and outputs.
data_dir = '/model_data/datasets/'
Dataset_names_path = "model_data/cells_names.txt"
Dataset_train = "model_data/cells_train.txt"
Dataset_test = "model_data/cells_test.txt"
is_subfolder = False
