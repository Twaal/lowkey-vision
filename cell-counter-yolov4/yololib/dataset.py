...
from yololib.utils import read_class_names, image_preprocess
from yololib.yolov3 import bbox_iou
...
class Dataset(object):
    ...
    def __init__(self, dataset_type, TEST_INPUT_SIZE=TEST_INPUT_SIZE):
        ...
        self.batch_count = 0
        print('Dataset initialized,', self.num_samples, self.batch_size)
