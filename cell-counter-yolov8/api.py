...
Place your model weights as models/best.pt (or set WEIGHTS_PATH env var).
"""
...
def get_model() -> YOLO:
    if not WEIGHTS_PATH.exists():
        raise RuntimeError(f"Weights not found at {WEIGHTS_PATH}. Please place your YOLOv8 model as models/best.pt or set WEIGHTS_PATH.")
